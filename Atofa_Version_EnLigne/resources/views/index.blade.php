	...
	<div class="container">
		...
		<div class="row trait-horizontal" id="dernieres-annonces">
			<div class="col-md-10 col-md-offset-1">
				<div class="row">
					<h2 class="text-uppercase text-center">Les dernières annonces</h2>
				</div>
				<div class="row">
		...
		<div class="row">
			<div class="jumbotron">
				<h1 class="text-center">Qui nous sommes </h1>
				<p class="text-center">Nous sommes un portail web conçu sur une idée selon laquelle les bonnes occasions se trouvent aux quatres coins de votre ville, voire près de chez vous, dans votre quartier.
				</p>
				<a href="{{ url('creer_compte') }}">
				<div class="btn-group btn-group-justified" role="group" aria-label="...">
					
						<div class="btn-group">
							<button type="button" class="btn btn-primary btn-lg text-uppercase"><strong>créez votre propre boutique</strong></button>
						</div>
