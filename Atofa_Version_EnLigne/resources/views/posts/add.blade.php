				...
				{!! Form::open(['route' => 'post.store', 'class' => 'form-horizontal', 'files' => true]) !!}
					...
					<div class="form-group ">
						<div class="btn-group btn-group-justified" role="group" aria-label="...">
							<div class="btn-group">
							<p class="text-center">Il est obligatoire de joindre une photo à votre annonce car cela permet d'augmenter vos chances et donne plus de crédibilité à votre annonce .</p>
