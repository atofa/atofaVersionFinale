	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9" id="annonces">
				...
				@else
				<div class="row well">
					<h1 class="text-center text-primary">Aucuns article de posté ...</h1>
			...
			<div class="col-md-3" id="pubs">
				<div class="row">
					...
					<img src="{{url('/')}}/assets/img/pubs/pub2.png" alt="..." class="img-thumbnail">
				</div>
				<div class="row">
					<img src="{{url('/')}}/assets/img/pubs/pub3.jpg" alt="..." class="img-thumbnail">
				</div>
				<div class="row">
					<img src="{{url('/')}}/assets/img/pubs/pub.png" alt="..." class="img-thumbnail">
				</div>
			</div>
		</div>
