...
class WelcomeController extends Controller{
	...
	public function boutiques(){
		...
		$boutiques = User::where('admin', '=', 0)->paginate(4);
	...
	public function offres(){
		...
		$offres = Post::where('type', '=', 'Offre')->paginate(4);
	...
	public function demandes(){
		...
		$demandes = Post::where('type', '=', 'Demande')->paginate(4);
	...
	public function showBoutiquePosts($user_id)
	{
		...
		return view('boutiquePosts', compact('posts','links','user'));
	}
